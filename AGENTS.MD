...
2. Command palette (`jupyter-jbang-runner:run-file`)
...
**ALWAYS** use `[jupyter-jbang-runner]` prefix:
```typescript
...
# Should show: jupyter-jbang-runner v1.0.0 enabled OK
```
...
- ✅ Browser console shows `[jupyter-jbang-runner] ✓ Extension activated`
